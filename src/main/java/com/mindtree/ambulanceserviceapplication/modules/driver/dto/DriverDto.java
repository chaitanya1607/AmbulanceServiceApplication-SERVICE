...
public class DriverDto {
	...
	@AssertFalse
	@Schema(description = "Application acceptance or rejection status (by admin)", required = false)
	...
	@Schema(description = "Driver's/ Applicant's Aadhaar proof", required = false)
	private byte[] aadhar;

	@Schema(description = "File type of Aadhaar proof", required = false)
	private String aadharFileType;

	@Schema(description = "Driver's/ Applicant's License Id proof", required = false)
	private byte[] license;
	@Schema(description = "File type of License Id proof", required = false)
	private String licenseFileType;
	@Schema(description = "Driver's/ Applicant's photo", required = false)
	private byte[] photo;
	...
	@AssertFalse
	@Schema(description = "Status of driver logged in the work", required = false)
	...
	@NotNull
	@Pattern(regexp = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=])(?=\\S+$).{8,}$", message = "Invaild password")
	@Schema(description = "Driver's/ Applicant's password", required = false)
	private String confirmPassword;

	@AssertFalse
	@Schema(description = "Status of driver is asssigned in the work", required = false)
